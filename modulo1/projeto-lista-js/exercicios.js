...
function checaRenovacaoRG() {
  ...
  console.log("Ano da identidade:",anoIdentidade)
  console.log("Prazo para renovação:", (anoAtual - anoIdentidade)% renovacao)
  console.log(renovacao)
  */

  const renova = true
  let calculaRG = (anoAtual - anoIdentidade) >= renovacao
...
function checaAnoBissexto(ano) {
  ...
  let mult400 = (ano % 400) === 0 
  let mult4 = (ano % 4) === 0
  let mult100 = (ano % 100) === 0
  
  let bissexto = (mult400 || mult4)
  let naobissexto = (mult100 !== mult400)
  
 // console.log("Múltiplo de 400", mult400)
 // console.log("Múltiplo de 4", mult4)
 // console.log("Múltilpo de 100",mult100)
 // console.log(bissexto && !naobissexto)

 return (bissexto && !naobissexto)
